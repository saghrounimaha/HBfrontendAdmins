...
const slider = [
    {
        ...
        Text: 'Thanks to the pandemic, e-commerce hasseen asurge of activity and new consumers. This projection is based on the fact thatthesector is expected to grow at 20 percent annually.'
    },
    {
        published: 'Zibra Fashion',
        bgColor: 'bg-primary',
        Text: 'Thanks to the pandemic, e-commerce hasseen asurge of activity and new consumers. This projection is based on the fact thatthesector is expected to grow at 20 percent annually.Live shopping could be a great innovationtoconsider as part of your strategy in 2022 to further build customer engagement,loyalty'
    }, {
        published: 'Sales Manager',
        bgColor: 'bg-danger',
        Text: 'Buying online has become necessary forsomecustomers, especially if they are part of the at- risk groups.'
    }
]
export { account, profile, transaction, slider }